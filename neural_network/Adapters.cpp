...
AdapterBegin::AdapterBegin(bool type_of_connection, size_t values_to_layer, size_t how_many_set, size_t data_shift):AdapterBegin(type_of_connection, values_to_layer, how_many_set)
{
	this->data_shift = data_shift;
	this->first_layer = nullptr;
}
